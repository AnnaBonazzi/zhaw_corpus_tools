...
What the script does:
	1) Picks corpus texts with chosen language and class, puts them together as word list
	2) Finds collocations (basis-collocate pairs) in window of given size
	3) Sorts collocations by log-likelihood value or pmi

! Requires all the encode/decode in python 2.7. Comment it out for python 3
'''
#--------------------------
...
for cl in classes:
	...
	print ('Searching corpus for class ' + cl + ', go have a coffee')
	...
	with open (output_folder + lang + '_'+cl+'.txt', 'a') as out:
